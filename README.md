...
| [SKILLS_SURVEY_2026_03_WEEK71](./SKILLS_SURVEY_2026_03_WEEK71.md) | Claude Code Skills 深度调研报告（第七十一周），ClawHub 实时搜索热门 Skills，游戏客户端开发（game-cog 1.134⭐/Unity-MCP 6580⭐/Godot-MCP 480⭐）/Python开发（py 1.052⭐/python 1.002⭐/fastapi 0.875⭐）/自动化测试（test-master 1.160⭐/Playwright 3.548⭐/e2e-testing-patterns 1.122⭐）/开发者工具（cli-developer 1.088⭐/mcp-adapter 1.075⭐）完整覆盖，ClawHub Top Skills 排行榜 | 🆕 新增 |
